...
def find_top_scorers(n_top_candidates=100, quiet=True, file_ext="", **kwargs):
    ...
    file = os.path.join("data", "wordle", "best_double_entropies.json")
    with open(file) as fp:
...
def find_best_two_step_entropy():
    ...
    ent_file = os.path.join("data", "wordle", "best_entropies.json")
    ...
    ent2_file = os.path.join("data", "wordle", "best_double_entropies.json")
